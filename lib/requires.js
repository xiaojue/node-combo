...
(function(ex) {
	if (ex) {
		var requireList = ['Mu','canvas','zlib','path', 'fs', 'util', 'http', 'url', 'events', 'querystring', 'net', 'os', 'vm', 'assert'],
		customsList = ['./template.js','./resize.js','./image.js','./combo.js','./tools.js','./range.js','./config.js', './handle.js','./headers.js'];
